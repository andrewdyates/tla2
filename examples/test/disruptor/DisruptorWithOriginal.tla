---- MODULE DisruptorWithOriginal ----
\* Debug version using original RingBuffer.tla
...
\* This uses the ORIGINAL RingBuffer.tla
...
\* This is the exact invariant from the original
