...
#[link(name = "zircon")]
extern "C" {
    pub fn zx_time_get(clock_id: u32) -> zx_time_t;

    pub fn zx_nanosleep(deadline: zx_time_t) -> zx_status_t;

    pub fn zx_ticks_get() -> u64;

    pub fn zx_ticks_per_second() -> u64;

    pub fn zx_deadline_after(nanoseconds: zx_duration_t) -> zx_time_t;

    pub fn zx_clock_adjust(handle: zx_handle_t, clock_id: u32, offset: i64) -> zx_status_t;

    pub fn zx_system_get_num_cpus() -> u32;

    pub fn zx_system_get_version(version: *mut u8, version_len: u32) -> zx_status_t;
    ...
    pub fn zx_thread_set_priority(prio: i32) -> zx_status_t;

    pub fn zx_process_exit(retcode: isize);
    ...
    pub fn zx_task_suspend(task_handle: zx_handle_t) -> zx_status_t;

    pub fn zx_task_resume(task_handle: zx_handle_t, options: u32) -> zx_status_t;

    pub fn zx_task_kill(task_handle: zx_handle_t) -> zx_status_t;
    ...
    pub fn zx_futex_wake(value_ptr: *const zx_futex_t, count: u32) -> zx_status_t;
    ...
    pub fn zx_timer_create(options: u32, clock_id: u32, out: *mut zx_handle_t) -> zx_status_t;
    ...
    pub fn zx_vmar_destroy(vmar_handle: zx_handle_t) -> zx_status_t;
    ...
    pub fn zx_cprng_draw(buffer: *mut u8, len: usize, actual: *mut usize) -> zx_status_t;

    pub fn zx_cprng_add_entropy(buffer: *const u8, len: usize) -> zx_status_t;
    ...
    pub fn zx_log_create(options: u32, out: *mut zx_handle_t) -> zx_status_t;
    ...
    pub fn zx_log_read(handle: zx_handle_t, len: u32, buffer: *mut u8, options: u32)
        -> zx_status_t;
    ...
    pub fn zx_debug_read(handle: zx_handle_t, buffer: *mut u8, length: u32) -> zx_status_t;

    pub fn zx_debug_write(buffer: *const u8, length: u32) -> zx_status_t;
    ...
    pub fn zx_interrupt_complete(handle: zx_handle_t) -> zx_status_t;

    pub fn zx_interrupt_wait(handle: zx_handle_t) -> zx_status_t;

    pub fn zx_interrupt_signal(handle: zx_handle_t) -> zx_status_t;

    pub fn zx_mmap_device_io(handle: zx_handle_t, io_addr: u32, len: u32) -> zx_status_t;
    ...
    pub fn zx_vcpu_resume(vcpu: zx_handle_t, packet: *mut zx_guest_packet_t) -> zx_status_t;

    pub fn zx_vcpu_interrupt(vcpu: zx_handle_t, vector: u32) -> zx_status_t;
