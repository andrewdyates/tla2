...
A more detailed version of the warning at the top level about the `quote`/`join`
family of APIs.
...
And many terminals detect when you paste a string containing control characters.  Terminal strips
...
to be compatible with those shells, plus all other POSIX-compatible shells.
...
routines wouldn't understand it.  Neither would this crate's own parser,
