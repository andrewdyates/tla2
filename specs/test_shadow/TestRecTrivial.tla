---------------------------- MODULE TestRecTrivial ----------------------------
(* Test recursive function mechanism with trivial body.
   SafeAt uses LET SA[bb \in Ballot] == TRUE IN SA[b] *)
EXTENDS Integers
...
\* Recursive function but trivial body
SafeAt(b, v) ==
  LET SA[bb \in Ballot] == TRUE
  IN  SA[b]
