...
//! behavior, some of which are . Therefore it is impossible to make
...
/// controlling their behavior, some of which are .
///
...
/// that the `ioctl` call is safe. The `ioctl` call may be , or it
